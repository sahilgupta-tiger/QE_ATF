...
def read_bigqueryschema(dict_connection, comparetype,spark):
  ...
  bqprojecttable = schemaname.split(".")

  bqquery = "select COLUMN_NAME as columnname, DATA_TYPE as datatype from ALL_TAB_COLUMNS where TABLE_NAME= '" + tablename + "' and owner ='" + schemaname +"'"
  ...
  df_bigqueryschema = (df_bigqueryschema
