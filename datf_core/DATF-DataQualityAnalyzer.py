...
dbutils.widgets.text('testsuite', 'dataqualitytest')
dbutils.widgets.text('dfname', 'df')
dbutils.widgets.text('json_file_path', '/Workspace/Shared/QE_ATF_Latest/datf_core/test/data/dataquality/test_data.json')
...
py_file = f"{work_path}/src/dqtester.py"
dfname = dbutils.widgets.get("dfname")
